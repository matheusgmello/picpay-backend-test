...
class TransactionServiceTest {
    ...
    void createdTransactionCase1() throws Exception {
        User sender = new User(1L,"Ronaldo", "Fenomeno",
                "99999999901", "fenomeno@gmail.com",
                "12345",
                new BigDecimal(10), UserType.COMMON);
        User receiver = new User(2L,"Ronaldinho", "Gaúcho",
                "99999999902", "gaucho@gmail.com",
                "12345",
                new BigDecimal(10), UserType.COMMON);
        ...
        transactionService.createdTransaction(request);
